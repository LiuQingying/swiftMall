...
extension API:TargetType{
    ...
    var path: String {
        ...
        case .homeData:
            return "/api/page/default/index"
        case .payMethod:
            return "/api/default/pay-method-list"
        case .productDetail:
            return "/api/goods/detail"
        case .categray:
    ...
    var method: Moya.Method {
        switch self {
        case .easyRequset,.homeData,.productDetail,.categray:
            return .get
        default:
            return .post
        }
...
//        return .requestParameters(parameters: nil, encoding: JSONArrayEncoding.default)
        ...
        case .payMethod :
            return .requestPlain
        case let .productDetail(parameters):
            return .requestParameters(parameters: parameters, encoding: URLEncoding.default)
...
//        return .requestParameters(parameters: params, encoding: URLEncoding.default)
    ...
    var headers: [String : String]? {
        return ["token":"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE1MzczMjg4MjIsInVpZCI6MjgwNDkzLCJhcHAiOiJpb3MifQ==.f5fff61c88d956ad5d6a1ef5f009daa1920fc392d160dbbc9a20f49f564d839f"]
    }
